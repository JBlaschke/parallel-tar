...
API documentation (generated by rustdoc from the docstrings, with this README
as the front page) is published to GitHub Pages on every push to `main`:
<https://jblaschke.github.io/parallel-tar/>
